...
export const CHANNEL_GUIDES: ChannelGuide[] = [
  {
    ...
    connectType: 'bot',
    steps: [
      'Click "Add Channel" and pick Telegram — a dialog shows our bot name and a one-time /connect code.',
      'In Telegram, add that bot to your channel or group and make it an administrator.',
      'Send the /connect code (copy it from the dialog) as a message in that channel or group.',
      'Go back to Postra — the channel is detected automatically within a few seconds.',
    ],
    gotchas: [
      "The bot must be an administrator — without admin rights it can't see the connect code or publish posts.",
