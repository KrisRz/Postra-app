...
export const OnboardingModal: FC<OnboardingModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="w-full min-h-full flex-1 p-[40px] flex relative">
      ...
      <div className="flex flex-1 bg-[rgba(15,23,42,0.92)] backdrop-blur-xl rounded-[20px] flex-col relative">
        <button
          ...
          <div className="flex flex-col gap-[24px] flex-1">
            ...
            <div className="flex items-center justify-center gap-[16px]">
              ...
              <div className="flex items-center gap-[8px]">
                ...
                >
                  {t('watch_tutorial', 'Watch the tutorial')}
                </span>
              </div>
            </div>
      ...
      <div className="flex gap-[4px] flex-col text-center">
        ...
        <div className="text-[14px] text-newTextColor/55">
          {t(
            ...
            'Watch a short video to get the most out of Postra'
          )}
        </div>
      </div>
